...
class FileDataViewer: AppCompatActivity() {
    ...
    companion object {
        ...
        private val colorSet = setOf(Color.RED, Color.GREEN, Color.BLUE, Color.GRAY, Color.YELLOW, Color.CYAN)
...
//        chart.moveViewToX(0f)
    ...
    private suspend fun dataParser(file: SensorFile) {
        withContext(Dispatchers.IO) {
            val dir = File(filesDir, "foot_pressure_record")
...
//                    addData(gyrChart, gyrValues.toSortedMap())
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // init emg chart
        initChart(emgChart, arrayOf("ADC"), 0f, 4095f) { "%.2f V".format(it / 4095f * 3.6f) }
        // init acc chart
